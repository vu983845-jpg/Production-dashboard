...
if (!supabaseKey) {
    console.error("Missing SUPABASE_SERVICE_ROLE_KEY. Run with: node -r dotenv/config create-viewer-account.js dotenv_config_path=.env.local");
    process.exit(1);
}

const supabase = createClient(supabaseUrl, supabaseKey);

const TARGET_EMAIL = 'Thien.Nguyen@dds.com';
const TARGET_PASSWORD = 'Thien123@';
const DISPLAY_NAME = 'Thiện Nguyễn';
