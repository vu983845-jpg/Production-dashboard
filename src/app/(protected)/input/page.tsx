                                                                        ...
                                                                        <TableRow>
                                                                            <TableCell colSpan={2} className="p-0">
                                                                                <details className="group bg-blue-50/50 border-b border-blue-100">
                                                                                    <summary className="flex items-center gap-2 px-4 py-3 cursor-pointer text-sm font-semibold text-blue-800 hover:bg-blue-100/50 transition-colors outline-none whitespace-normal break-words">
                                                                                        <HelpCircle className="w-4 h-4 flex-shrink-0" />
                                                                                        <span>Hướng dẫn nhập liệu bộ phận Shelling (Tự động hóa)</span>
                                                                                    </summary>
                                                                                    <div className="px-4 pb-4 pt-2 text-xs text-slate-700 space-y-2 leading-relaxed border-t border-blue-100/50 bg-white whitespace-normal break-words">
                                                                                        ...
                                                                                        <p><strong>3. Thời gian chạy Shelling:</strong> <span className="text-green-600 font-medium">Hệ thống tự tính</span> (bằng 7 tiếng trừ đi số phút Dừng máy). Bị khóa, không cần nhập tay.</p>
                                                                                        <p><strong>4. Thời gian dừng Shelling:</strong> <span className="text-red-600 font-medium">Tự động lấy dữ liệu</span> từ Hệ thống Báo Cáo Sự Cố qua. Không cần nhập tay.</p>
