...
const SECTION_MAP = {
    ...
    'Manual Grading -Shift 1 (Ms Huệ)':         { code: 'HAND',       shift: '1', type: 'official' },
    'Manual Grading Thời vụ -Shift 1 (Ms Huệ)': { code: 'HAND',       shift: '1', type: 'seasonal' },
    'Manual Grading -Shift 2 (Ms Huệ)':         { code: 'HAND',       shift: '2', type: 'official' },
    'Manual Grading Thời vụ -Shift 2 (Ms Huệ)': { code: 'HAND',       shift: '2', type: 'seasonal' },
    'Manual Grading -Shift 3 (Ms Huệ)':         { code: 'HAND',       shift: '3', type: 'official' },
    'Manual Grading Thời vụ -Shift 3 (Ms Huệ)': { code: 'HAND',       shift: '3', type: 'seasonal' },
    'Manual peeling S1 - Liên':                 { code: 'HAND',       shift: '1', type: 'official' },
    'Manual peeling S1 thời vụ - Liên':         { code: 'HAND',       shift: '1', type: 'seasonal' },
    'Manual peeling S1 - Dung':                 { code: 'HAND',       shift: '1', type: 'official' },
    'Manual peeling S1 thời vụ - Dung':         { code: 'HAND',       shift: '1', type: 'seasonal' },
    'Manual peeling S2 - Liên':                 { code: 'HAND',       shift: '2', type: 'official' },
    'Manual peeling S2 thời vụ - Liên':         { code: 'HAND',       shift: '2', type: 'seasonal' },
    'Manual peeling S2 - Dung':                 { code: 'HAND',       shift: '2', type: 'official' },
    'Manual peeling S2 thời vụ - Dung':         { code: 'HAND',       shift: '2', type: 'seasonal' },
    'Manual peeling S3 - Liên':                 { code: 'HAND',       shift: '3', type: 'official' },
    'Manual peeling S3 thời vụ - Liên':         { code: 'HAND',       shift: '3', type: 'seasonal' },
    'Manual peeling S3 - Dung':                 { code: 'HAND',       shift: '3', type: 'official' },
    'Manual peeling S3 thời vụ - Dung':         { code: 'HAND',       shift: '3', type: 'seasonal' },
    // PACKING
