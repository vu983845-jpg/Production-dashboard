                        ...
                        {ALL_SEU_IDS.map(id => {
                            ...
                            if (id === 5) {
                                ...
                                return <div key={id} className="rounded-lg flex flex-col overflow-hidden" style={{ background: '#FFFFFF', border: `1.5px solid ${cfg.border}`, boxShadow: '0 1px 3px rgba(142,30,25,0.07)' }}>
                                    ...
                                    <div className="px-2 pt-1"><div style={{ fontSize: 15, fontWeight: 900, color: cfg.color, lineHeight: 1, fontVariantNumeric: 'tabular-nums' }}>{waterPiPerTon != null ? waterPiPerTon.toFixed(3) : '-'}</div><div style={{ fontSize: 7, color: '#0F766E', marginTop: 1, fontWeight: 700 }}>WATER PI (M3 / TON RCN)</div></div>
