...
## SPECIAL FORMATS
1. Ca 1.2.3 (Boiler): create 3 records shift="1","2","3" with the SAME values (each shift has that many people).
...
Ex1 Boiler Ca 1.2.3 (same CT HD per shift — each shift has that many people):
